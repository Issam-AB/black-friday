            ...
            <div className="flex items-center gap-4">
              ...
              <div className="relative w-[280px]">
                ...
                <input
                  ...
                  className="w-full bg-[var(--bg-filter)] text-white placeholder:text-white/40 placeholder:text-xs placeholder:font-semibold rounded-lg pl-11 pr-4 py-3 text-sm font-medium focus:outline-none focus:ring-2 focus:ring-[var(--color-primary)] transition-all uppercase"
                />
              </div>
            </div>
          </div>
          ...
          <div className="flex items-center gap-2 flex-1 justify-end">
            ...
            <div className="relative flex-1 max-w-[180px] sm:max-w-[240px]">
              ...
              <input
                ...
                value={searchQuery}
                onChange={(e) => setSearchQuery(e.target.value)}
                className="w-full bg-[var(--bg-filter)] text-white placeholder:text-white/50 rounded-lg pl-8 pr-3 py-2 text-xs sm:text-sm focus:outline-none focus:ring-2 focus:ring-[var(--color-primary)] transition-all"
              />
            </div>
          </div>
        </div>
